...
@section("content")
	<div class="container m-auto min-h-screen pt-12">
		@foreach($cards->groupBy(function ($card)  {return $card->isAnswer();})->reverse() as $deck)
			<main class="mx-auto flex flex-row text-lg flex-wrap py-10">

				@foreach($deck as $card)
					<div class="@if($card->isAnswer()) bg-white text-gray-900 @else bg-gray-900 text-gray-100 @endif
